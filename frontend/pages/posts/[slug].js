        ...
        <article className="mx-56 px-6 py-24 space-y-12 text-black">
            ...
            <div className="pt-12 border-t dark:border-gray-700">
                ...
                <div className="flex justify-center pt-4 space-x-4 align-center">
                    <Link rel="noopener noreferrer" href="#" aria-label="GitHub" className="p-2 rounded-md text-black hover:text-violet-400">
                    ...
                    <Link rel="noopener noreferrer" href="#" aria-label="Dribble" className="p-2 rounded-md text-black hover:text-violet-400">
                    ...
                    <Link rel="noopener noreferrer" href="#" aria-label="Twitter" className="p-2 rounded-md text-black hover:text-violet-400">
                        <svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 fill-current">
                    ...
                    <Link rel="noopener noreferrer" href="#" aria-label="Email" className="p-2 rounded-md text-black hover:text-violet-400">
                        <svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 fill-current">
